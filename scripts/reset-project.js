 ...
 * It deletes or moves the /app, /src, and /scripts directories to /example based on user input and creates a new /app directory with an index.tsx and _layout.tsx file.
...
const moveDirectories = async (userInput) => {
  try {
    ...
    console.log(
      ...
      `1. Run \`npx expo start\` to start a development server.\n2. Edit app/index.tsx to edit the main screen.\n3. Put route files in /app and shared application code in /src.${
        userInput === "y"
